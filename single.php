...
?>
		...
		<p class="h4 cardo"><?php the_title();?></p>
...
<a href="<?php the_permalink() ?>"> <img class="img-fluid" src="<?php echo $url ?>" /></a>
<span class="productSubTitle"><?php the_category( ' | ' ); ?> </span>
	<p class="h4">
